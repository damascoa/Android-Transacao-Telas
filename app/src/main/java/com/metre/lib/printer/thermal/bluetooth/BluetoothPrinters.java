package com.metre.lib.printer.thermal.bluetooth;

import android.bluetooth.BluetoothClass;

import com.metre.lib.bluetooth.BluetoothDeviceSocketConnexion;
import com.metre.lib.bluetooth.BluetoothDevices;
...
public class BluetoothPrinters extends BluetoothDevices {
    ...
    public static BluetoothPrinterSocketConnexion selectFirstPairedBluetoothPrinter() {
        ...
        if (bluetoothPrinters != null && bluetoothPrinters.length > 0) {
            for (BluetoothPrinterSocketConnexion printer : bluetoothPrinters) {
                System.out.println("NAME PRINTER::::::::::: "+printer.getDevice().getName());
                if (printer.getDevice().getName().equals("BlueTooth Printer")) {
                    System.out.println("CONNECT PRINTER::::::::::: "+printer.getDevice().getName());
                    return printer;
                }
            }
        }
    ...
    public static BluetoothPrinterSocketConnexion selectFirstPairedBluetoothPrinter(String name) {
        BluetoothPrinters printers = new BluetoothPrinters();
        BluetoothPrinterSocketConnexion[] bluetoothPrinters = printers.getList();
        ...
        if (bluetoothPrinters != null && bluetoothPrinters.length > 0) {
            for (BluetoothPrinterSocketConnexion printer : bluetoothPrinters) {
                System.out.println("NAME PRINTER::::::::::: "+printer.getDevice().getName());
                if (printer.getDevice().getName().equals(name)) {
                    System.out.println("CONNECT PRINTER::::::::::: "+printer.getDevice().getName());
                    return printer;
                }
            }
