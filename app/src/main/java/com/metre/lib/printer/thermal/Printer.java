package com.metre.lib.printer.thermal;

import android.graphics.Bitmap;

import com.metre.lib.printer.thermal.bluetooth.BluetoothPrinterSocketConnexion;
import com.metre.lib.printer.thermal.textparser.PrinterTextParser;
import com.metre.lib.printer.thermal.textparser.PrinterTextParserBarcode;
import com.metre.lib.printer.thermal.textparser.PrinterTextParserColumn;
import com.metre.lib.printer.thermal.textparser.PrinterTextParserElement;
import com.metre.lib.printer.thermal.textparser.PrinterTextParserImg;
import com.metre.lib.printer.thermal.textparser.PrinterTextParserLine;
import com.metre.lib.printer.thermal.textparser.PrinterTextParserString;
...
public class Printer {
    ...
    public Printer(BluetoothPrinterSocketConnexion printer, int printerDpi, float printingWidthMM, int nbrCharactersPerLine) {
        System.out.println("PRINTER CONNECTED: "+printer.isConnected());
        System.out.println("PRINTER CONNECTED: "+printer.isConnected());
